-- Entry point for the MiniKillingBlow test suite. Run from the repository root:
--
...
io.write("MiniKillingBlow - unit tests\n")
io.write("======================================\n")

local testFiles = {
	"tests/TestSmoke.lua",
	"tests/TestSoundEffects.lua",
	"tests/TestPartyKill.lua",
}
